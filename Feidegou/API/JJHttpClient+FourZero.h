...
//加入购物车
-(RACSignal*)requestFourZeroAddCartGoods_id:(NSString *)goods_id andcount:(NSString *)count andsotre_id:(NSString *)sotre_id andproperty:(NSString *)property andspec_info:(NSString *)spec_info andUser_id:(NSString *)user_id;
//修改购物车数量
