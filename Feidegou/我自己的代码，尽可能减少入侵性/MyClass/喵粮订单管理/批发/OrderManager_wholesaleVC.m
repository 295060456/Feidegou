...
#import "OrderManager_wholesaleVC.h"
#import "SearchView.h"
#import "OrderListTBVCell.h"
#import "OrderManager_wholesaleVC+VM.h"
#import "OrderListVC.h"

@interface OrderManager_wholesaleVC ()
<
UITableViewDelegate,
...
@implementation OrderManager_wholesaleVC
...
+ (instancetype)ComingFromVC:(UIViewController *)rootVC
    ...
    OrderManager_wholesaleVC *vc = OrderManager_wholesaleVC.new;
...
-(void)pullToRefresh{
    ...
    [self networking_platformType:PlatformType_Wholesale];
}
//上拉加载更多
    ...
    if (!_searchView) {
        ...
        [_searchView actionBlock:^(id data) {
            ...
            if ([data isKindOfClass:[MMButton class]]) {
                ...
                if ([btn.titleLabel.text isEqualToString:@"已支付"]) {//0
                    [self networking_type:BusinessType_HadPaid];
                }else if ([btn.titleLabel.text isEqualToString:@"已接单"]){//2 已下单
