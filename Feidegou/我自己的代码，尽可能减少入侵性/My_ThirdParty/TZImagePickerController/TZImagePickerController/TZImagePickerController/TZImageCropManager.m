...
+ (UIImage *)cropImageView:(UIImageView *)imageView
    ...
    // 平移的处理
    CGRect imageViewRect = [imageView convertRect:imageView.bounds
    ...
    CGPoint zeroPoint = CGPointMake((CGRectGetWidth(containerView.frame) - xMargin) / 2,
                                    containerView.center.y);
    CGPoint translation = CGPointMake(point.x - zeroPoint.x,
                                      point.y - zeroPoint.y);
    transform = CGAffineTransformTranslate(transform, translation.x,
                                           translation.y);
    // 缩放的处理
...
+ (CGImageRef)newTransformedImage:(CGAffineTransform)transform
    ...
    uiCoords = CGAffineTransformTranslate(uiCoords,
                                          cropSize.width/2.0,
                                          cropSize.height / 2.0);
    uiCoords = CGAffineTransformScale(uiCoords,
                                      1.0,
                                      -1.0);
    ...
    CGContextDrawImage(context, CGRectMake(-imageViewSize.width/2,
