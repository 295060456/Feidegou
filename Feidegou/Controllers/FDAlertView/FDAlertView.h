...
@property (assign, nonatomic) BOOL isForBidClickBack;
...
- (void)alertView:(FDAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex andTextFiled:(NSString *)strText;
