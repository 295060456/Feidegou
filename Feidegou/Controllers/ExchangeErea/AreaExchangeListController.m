...
//    原价和现价
     ...
     [atrStringPrice addAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:15.0]} range:NSMakeRange(0, strPriceNow.length)];
     [atrStringPrice addAttributes:@{NSStrikethroughStyleAttributeName:[NSNumber numberWithInteger:NSUnderlineStyleSingle]} range:NSMakeRange(strPriceNow.length+3, strPriceOld.length)];
    [atrStringPrice addAttributes:@{NSForegroundColorAttributeName:ColorGary,NSFontAttributeName:[UIFont systemFontOfSize:11.0]} range:NSMakeRange(strPriceNow.length, atrStringPrice.length-strPriceNow.length)];
    ...
    [atrStringNum addAttributes:@{NSForegroundColorAttributeName:ColorHeader} range:NSMakeRange(2+strNum.length, atrStringNum.length-strNum.length-2)];
