...
@interface ViewForTypeSelectLeftSlide()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
//        隐藏按钮
        ...
        self.viBack = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
        ...
        self.viContent = [[UIView alloc] initWithFrame:CGRectMake(SCREEN_WIDTH, 0, SCREEN_WIDTH-40, SCREEN_HEIGHT)];
        [self.viContent setBackgroundColor:[UIColor whiteColor]];
        [self addSubview:self.viContent];
        
        
        self.viHead = [[UIView alloc] initWithFrame:CGRectMake(0, 20, CGRectGetWidth(self.viContent.frame), 110)];
        [self.viHead setBackgroundColor:[UIColor whiteColor]];
        [self.viContent addSubview:self.viHead];
        UIButton *btnEndEditing = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.viHead.frame), CGRectGetHeight(self.viHead.frame))];
        ...
        self.lblPrice = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, 105, 30)];
        [self.lblPrice setFont:[UIFont systemFontOfSize:15]];
        [self.lblPrice setText:@"价格区间"];
        [self.viHead addSubview:self.lblPrice];
        
        self.txtPriceBegin = [[UITextField alloc] initWithFrame:CGRectMake(30, CGRectGetMaxY(_lblPrice.frame)+10, (CGRectGetWidth(self.viHead.frame)-60-10)/2, 30)];
        ...
        self.txtPriceEnd = [[UITextField alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.txtPriceBegin.frame)+10, CGRectGetMinY(self.txtPriceBegin.frame), CGRectGetWidth(self.txtPriceBegin.frame), CGRectGetHeight(self.txtPriceBegin.frame))];
        ...
        self.collectionViewType = [[UICollectionView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.viHead.frame), CGRectGetWidth(self.viContent.frame), SCREEN_HEIGHT-CGRectGetMaxY(self.viHead.frame)-40) collectionViewLayout:layout];
        ...
        [self.collectionViewType registerClass:[CLCellGoodTypeHead class] forCellWithReuseIdentifier:@"CLCellGoodTypeHead"];
        [self.collectionViewType registerClass:[UICollectionReusableView class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"reusableView"];

        
        
        UIView *viButton = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.collectionViewType.frame), CGRectGetWidth(self.viContent.frame), 40)];
        
        UIButton *btnReset = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(viButton.frame)/2, CGRectGetHeight(viButton.frame))];
        ...
        UIButton *btnConfilm = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(btnReset.frame), 0, CGRectGetWidth(viButton.frame)/2, CGRectGetHeight(viButton.frame))];
...

{
    ...
    if (kind == UICollectionElementKindSectionHeader){
        ...
        if (!lblHead) {
            ...
            imgAll = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.viContent.frame)-10-14, 0, 14, CGRectGetHeight(headerView.frame))];
            [imgAll setContentMode:UIViewContentModeScaleAspectFit];
            
            [imgAll setTag:102];
            
            lblAll = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(lblHead.frame)+5, 0, CGRectGetMinX(imgAll.frame)-5-CGRectGetMaxX(lblHead.frame)-5, CGRectGetHeight(headerView.frame))];
            [lblAll setFont:[UIFont systemFontOfSize:13]];
            [lblAll setTextAlignment:NSTextAlignmentRight];
            [lblAll setTag:101];
            btnAll = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMinX(lblAll.frame), 0, CGRectGetMaxX(imgAll.frame)-CGRectGetMinX(lblAll.frame), CGRectGetHeight(headerView.frame))];
        ...
        [btnAll handleControlEvent:UIControlEventTouchUpInside withBlock:^{
