...
@interface XDMultTableView : UIView
<
UITableViewDelegate,
 ...
 *
 */
- (BOOL)mTableView:(XDMultTableView *)mTableView
canEditRowAtIndexPath:(NSIndexPath  *)indexPath;

/**
 *  cell编辑后回调
 */
- (void)mTableView:(XDMultTableView *)tableView
commitEditingStyle:(XDMultTableViewCellEditingStyle)editingStyle
 ...
 *  section View
 */
- (UIView *)mTableView:(XDMultTableView *)mTableView
 ...
 *  设置cell的编辑类型
 */
- (XDMultTableViewCellEditingStyle)mTableView:(XDMultTableView *)mTableView
